System.register(["lodash", "jquery", "app/core/utils/kbn", "app/core/config", "app/core/time_series2", "app/plugins/sdk"], function (exports_1, context_1) {
    ...
    //TdmVariables//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    var maxTdm=0;//max value gauge
    var treesholdTdm=0;//threeshold value gauge
    var bigValueIndex = 0;//index first query
    var secondValueIndex = 1;//index second query
    var thirdValueIndex = 2;//index third query
    var fourthValueIndex = 3;//index fourth query
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        execute: function () {
            SingleStatCtrl = (function (_super) {
                ...
                SingleStatCtrl.prototype.onInitEditMode = function () {
                    ...
                    this.addEditorTab('TDMOptions', 'public/plugins/singlestat_ec/tdmoptions.html', 4);
                ...
                SingleStatCtrl.prototype.setValues = function (data) {
                    ...
                    if (this.series.length > 1 && bigValueIndex === 0 && sparklineIndex === 0) {//////////////////////////////////////////////////////////////////////////////////77
                        var error = new Error();
                    ...
                    //Tdm checkbox/////////////////////////////////////////////////////////////////////////////////////////////////////////
                    //If the checkbox isn't selected the plugin's bahaviour is the original
                    if(this.panel.gauge.customquery){
                        if(this.series ){
                            maxTdm=Math.round(lodash_1.default.last(this.series[secondValueIndex].datapoints)[0]*100)/100;
                            treesholdTdm=(Math.round(parseFloat(lodash_1.default.last(this.series[thirdValueIndex].datapoints)[0])*100))/100+","+(Math.round((parseFloat(lodash_1.default.last(this.series[fourthValueIndex].datapoints)[0]))*100)/100);
                            this.panel.gauge.maxValue=maxTdm;
                            this.panel.thresholds=treesholdTdm;
                        }
                    }
                ...
                SingleStatCtrl.prototype.link = function (scope, elem, attrs, ctrl) {
                    ...
                    function render() {
                        ...
                        div.innerHTML="<div  style='position: absolute;top: 80%;left: 0;' class='info legend leaflet-control'>"+
                        "<div class='legend-item'><i style='background:"+data.colorMap[0]+"'></i> < Media</div>"+
                        "<div class='legend-item'><i style='background:"+data.colorMap[1]+"'></i> = Media</div>"+
                        "<div class='legend-item'><i style='background:"+data.colorMap[2]+"'></i> > Media</div></div>";
                        elem.append(div);
                        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
